            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
                ...
                <div class="sidebar-menu-content" id="dashboardheight">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view navBar">
                        ...
                        <li class="nav-item" @click="submenu(0)">
                                <router-link :to="{ name: 'applicationlist', params:{type:'processing'} }" class="nav-link"><i
                                    class="flaticon-dashboard"></i><span>তদন্তাধীন আবেদন</span></router-link>
                        </li>


                        <li class="nav-item" @click="submenu(0)" v-if="this.$localStorage.getItem('position') == 'admin'">
                                <router-link :to="{ name: 'applicationlist', params:{type:'processied'} }"  class="nav-link"><i
                                    class="flaticon-dashboard"></i><span>তদন্তকৃত আবেদন</span></router-link>
                        </li>


                        <li class="nav-item" @click="submenu(0)" v-if="this.$localStorage.getItem('position') == 'admin'">
                                <router-link  :to="{ name: 'applicationlist', params:{type:'approved'} }" class="nav-link"><i
                                    class="flaticon-dashboard"></i><span>অনুমোদিত আবেদন</span></router-link>
                        </li>


                        <li class="nav-item" @click="submenu(0)" v-if="this.$localStorage.getItem('position') == 'admin'" >
                                <router-link  :to="{ name: 'applicationlist', params:{type:'canceled'} }" class="nav-link"><i
                                    class="flaticon-dashboard"></i><span>বাতিলকৃত আবেদন</span></router-link>
                        </li>
